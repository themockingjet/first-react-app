...
function Collaborate() {
    return(
        <section id="client" className="overlay bg-fixed" style={{backgroundImage: 'url(../assets/img/bg.jpg)'}}>
            <div className="container">
                <div className="section-content" data-aos="fade-up">
                    <div className="row ">
                        ...
                        loop={true} autoplay={true} center={true} items={5} margin={50} autoplayTimeout={1000}
                        smartSpeed={500} dots={false}>
